...
ExTEMPO is in active development, so please report any issues or suggestions on GitHub (https://github.com/BRajkumar041992). The first version is in the form of a Jupyter notebook (ExTEMPO_v1_1.ipynb) for easy access. 
